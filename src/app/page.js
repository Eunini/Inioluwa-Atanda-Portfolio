...
export default function Home() {
  return (
    <PageLayout>
      ...
      >
        ...
        <div className="space-y-3">
          {projects.map((project, i) => (
            <motion.div key={project.name} variants={fadeUp} custom={i + 1} className="card card-cyan p-6 sm:p-8 group">
      ...
      <section id="contact" className="flex flex-wrap gap-3 justify-center scroll-mt-24">
        <a
